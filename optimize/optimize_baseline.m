function [g, c, f, flag] = optimize_baseline(N, constraints, f_opt_prior)
flag = -1;
max_retry = 10;
num_retry = 0;
while num_retry < max_retry
    ...
    c = rand(N, 1);
    x = [g; c];
    options = optimoptions('fmincon','Algorithm', 'sqp', 'Display', 'off', 'ConstraintTolerance', 1e-10, 'GradObj', 'on');
